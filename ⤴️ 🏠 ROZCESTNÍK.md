---
typ: rozcestnik
nazev: Hlavní rozcestník — Kauza TJ Krupka
...
```mermaid
flowchart TD
    MK["🏛️ Město Krupka"] -->|"100% vlastník"| SK["SPORT Krupka s.r.o."]
    SK -->|"provozuje"| PIN["🎳 Pinčesárna"]
    MK <-->|"SMĚNA POZEMKŮ"| LCR["🌲 Lesy ČR"]

    JK["👤 Jan Kuzma\nstarosta"] -->|"řídí"| MK
    JK -->|"100% vlastník"| SK
    JB["👤 Jan Bokoč\nradní"] -->|"MOTIV: převzít areál"| MK
    AV["👤 Adolf Vítů\njednatel"] -->|"jednatel"| SK
    AV -->|"místostarosta"| MK

    VP["👥 Vaniš + Pivoňka"] -->|"ovládají"| KST["KST Krupka"]
    KST -->|"člen"| KSSTUK["KSSTÚK"]
    KSSTUK -->|"člen"| CAST["ČAST\nignoruje stížnosti"]
    CAST -.-|"má řešit"| TJ["⚖️ TJ Krupka"]

    ROU["👤 JUDr. Rousek"] -->|"advokát"| VP
    ROU -->|"advokát"| VLA["👤 Gustav Vlach"]

    KUC["👤 Mgr. Kučera"] -->|"advokát"| TJ
    BR["👤 M. Brožek"] -->|"předseda"| TJ

    VP -->|"bývalí členové"| TJ
    VLA -->|"bývalý člen"| TJ
```
